...
//     }
// });
export const fetchUserInit = createAsyncThunk("userDashboard/fetchUserInit", async ({userId, startDate, endDate }, thunkAPI) => {
    try {
        const response = await userDashboard.init(userId, startDate, endDate);
        thunkAPI.dispatch(setCharts(response?.data?.summary?.chartData));
        return response.data;
    } catch (error) {
        return thunkAPI.rejectWithValue(error.response.data);
...
export const fetchFilteredData = createAsyncThunk("userDashboard/fetchFilteredData", async ({userId, startDate, endDate}, thunkAPI) => {
    try {
        const response = await userDashboard.init(userId, startDate, endDate);
        thunkAPI.dispatch(setCharts(response?.data?.summary?.chartData));
        return response.data;
...
// export const fetchUserInit = createAsyncThunk("userDashboard/fetchUserInit", async ({userId, range }, thunkAPI) => {
//     try {
//         const response = await userDashboard.init(userId, range);
//         thunkAPI.dispatch(setCharts(response?.data?.summary?.chartData));
//         return response.data;
//     } catch (error) {
//         return thunkAPI.rejectWithValue(error.response.data);
...
// export const fetchFilteredData = createAsyncThunk("userDashboard/fetchFilteredData", async ({userId, range}, thunkAPI) => {
//     try {
//         const response = await userDashboard.init(userId, range);
//         thunkAPI.dispatch(setCharts(response?.data?.summary?.chartData));
//         return response.data;
...
export const selectUserMeterDataDaily = (state) => state.userDashboard.userMeterDataDaily;
export const selectUserMeterData30Days = (state) => state.userDashboard.userMeterData30Days;
export const selectRecentData = (state) => state.userDashboard.data?.summary?.recentData;
