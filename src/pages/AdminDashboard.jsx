...
const Dashboard = () => {
      ...
      <div className="bg-white border border-white p-6">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="heading-lg font-semibold text-gray-800">Recent Alerts</h3>
          ...
          {recentNotifications.length > 0 ? (
            recentNotifications.map((notification) => (
              ...
              >
                ...
                <div className="text-gray-600 body-xs   font-medium mb-3">
            ...
            <div className="text-center py-4">
              <p className="body-xs   font-medium text-gray-500">No recent alerts</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-md shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all duration-200 w-full flex flex-col relative">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-1">
            <div className="relative group flex items-center space-x-1 body-xs font-medium">
              ...
              <span className={`body-xs font-semibold ${isPositive ? "text-green-600" : "text-red-600"}`}>
                {change}
              </span>
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 w-max px-2 py-1 body-xs text-black bg-white rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 shadow-md">
                ...
                <div className="text-gray-500 body-xs mt-1">vs previous day</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col min-w-0">
            {valueRoute ? (
              <Link to={valueRoute} className="text-2xl font-bold text-gray-900 hover:underline cursor-pointer">
                <h3 className="body-xs font-medium text-gray-600 mb-1 truncate">{title}</h3>
                <p className="text-2xl font-bold text-gray-900 truncate">
                  {value} {metricUnit && (<span className="body-xs   font-normal">{metricUnit}</span>)}
                </p>
              </Link>
            ) : (
              <>
            ...
            <div className="flex flex-col items-end min-w-0">
              {subValueRoute ? (
                <Link to={subValueRoute} className="text-2xl font-bold text-gray-900 hover:underline cursor-pointer">
                  <p className="body-xs font-medium text-gray-600 mb-1 truncate">{subLabel}</p>
        ...
        <div className="w-full mt-auto relative z-10">
          <div className="flex items-center justify-between mb-1">
            {trend && <div className="body-xs font-medium text-gray-600 truncate">{title}</div>}
            <div className="flex-grow" />
            {secondaryTrend && <div className="body-xs font-medium text-gray-600 truncate text-right">{secondaryTrendLabel}</div>}
          </div>
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-gray-500 heading-lg">Loading Dashboard...</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-red-500 heading-lg">
  ...
  if (!data) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-gray-500 heading-lg">No dashboard data found.</p>
      </div>
    );
  }
    ...
    <div className="bg-blue-200/10 min-h-screen">
      <div className="bg-white px-4 sm:px-6 py-4">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="heading-md sm:heading-lg md:heading-xl font-semibold text-gray-900">
              Admin Dashboard
            </h1>
      ...
      <div className="mx-4 sm:mx-6 mt-6 mb-4 bg-white border border-gray-200 rounded-md shadow-sm hover:shadow-md transition-shadow">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-6 gap-6">
          <div className="flex items-center space-x-6">
            ...
            <div>
              <h2 className="heading-lg font-semibold text-emerald-800 mb-1">
                Total Revenue
              </h2>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="heading-md font-bold text-gray-800">
