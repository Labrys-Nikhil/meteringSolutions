...
export const adminDashboard = {
  getRecentData: (adminId) => api.get(`/adminDashboard/recent-data/${adminId}`),
  getAdminDailyConsumption: (adminId) => api.get(`/adminDashboard/get-admin-daily-consumption/${adminId}`),
  getFilteredChartData: ({ adminId, from, to }) => {
    ...
    return api.get(`/adminDashboard/get-admin-daily-consumption/${adminId}`, { params });
  },
  getAdminUserMeterData: (adminId) => api.get(`/adminDashboard/get-userdata-by-admin/${adminId}`),
  getMeterListByAdmin: (adminId) => api.get(`/adminDashboard/get-meter-by-admin/${adminId}`),
};
