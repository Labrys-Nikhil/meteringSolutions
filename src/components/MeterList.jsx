...
//         Meters Overview
//       </h3>
//       <p className="body-sm text-gray-500">{meters.length} meters</p>
//     </div>
//   </div>

//   {/* Right: Search */}
//  <div className="w-full max-w-[12rem] mt-2 sm:mt-0">
...
//       className="w-full border border-gray-300 rounded-md pl-10 pr-3 py-3 body-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
//       value={searchQuery}
