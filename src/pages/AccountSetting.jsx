      ...
      <section className="bg-white rounded-xl shadow-md p-6 mb-6">
        ...
        <form onSubmit={handleProfileSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block body-sm   font-medium text-gray-700 mb-1 flex items-center">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {!showAddPayment && (
            <button 
              ...
              className="text-blue-600 hover:text-blue-800 font-medium flex items-center body-sm  "
            >
        ...
        {showAddPayment ? (
          <div className="mb-6 p-4 border border-blue-200 rounded-lg bg-blue-50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
              <div>
                <label className="block body-sm   text-gray-700 mb-1">Card Number</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block body-sm   text-gray-700 mb-1">Cardholder Name</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block body-sm   text-gray-700 mb-1">Expiry Date</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block body-sm   text-gray-700 mb-1">CVV</label>
                <input
                  type="text"
            ...
            <div className="flex space-x-2">
              <button 
                ...
                className="bg-blue-600 text-white px-4 py-2 rounded-lg body-sm   flex items-center"
              >
                <Check className="w-4 h-4 mr-1" /> Save Card
              </button>
              <button 
                onClick={() => setShowAddPayment(false)}
                className="border border-gray-300 px-4 py-2 rounded-lg body-sm  "
              >
                Cancel
              </button>
            </div>
            ...
            <div key={method.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-blue-200 transition">
              <div className="flex items-center">
                <div className="bg-gray-100 border rounded-lg w-12 h-8 mr-4 flex items-center justify-center">
                  {method.type === 'visa' ? (
                    <span className="text-blue-800 font-bold body-xs ">VISA</span>
                  ) : (
                    <span className="text-red-700 font-bold body-xs ">MC</span>
                  )}
                </div>
                <div>
                  ...
                  <p className="body-sm   text-gray-500">Exp {method.expiry}</p>
                </div>
              </div>
              <div className="flex space-x-3">
                {method.primary ? (
                  <span className="px-3 py-1 bg-green-100 text-green-800 body-xs  rounded-full flex items-center">
                    <Check className="w-3 h-3 mr-1" /> Primary
                  </span>
                ) : (
                  <button 
                    onClick={() => setPrimaryMethod(method.id)}
                    className="text-blue-600 hover:text-blue-800 body-sm   flex items-center"
                  >
                ...
                <button 
                  ...
                  className="text-red-600 hover:text-red-800 body-sm   flex items-center"
                >
        ...
        <div className="space-y-3">
          <button className="w-full text-left p-3 hover:bg-gray-50 rounded-lg flex items-center border border-gray-200">
            ...
            <div>
              ...
              <p className="body-sm   text-gray-500">Secure your account by signing out everywhere</p>
            </div>
          </button>
          <button className="w-full text-left p-3 hover:bg-red-50 text-red-600 rounded-lg flex items-center border border-red-100">
            ...
            <div>
              ...
              <p className="body-sm  ">Permanently delete your account and all data</p>
            </div>
          </button>
        </div>
      </section>
