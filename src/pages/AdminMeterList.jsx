        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <label className="block body-xs  font-medium text-gray-700">Meter Name</label>
                <p className="heading-lg text-gray-900 font-medium mt-1">{selectedMeter.name}</p>
              </div>
              <div>
                <label className="block body-xs  font-medium text-gray-700">Meter ID</label>
                <p className="heading-lg text-gray-900 font-medium mt-1">{selectedMeter.meterId}</p>
              </div>
              <div>
                <label className="block body-xs  font-medium text-gray-700">Meter Type</label>
                <p className="heading-lg text-gray-900 font-medium mt-1">{selectedMeter.type}</p>
              </div>
              <div>
                <label className="block body-xs  font-medium text-gray-700">Serial Number</label>
                <p className="heading-lg text-gray-900 font-medium mt-1">{selectedMeter.meterSerialNumber}</p>
              </div>
              <div>
                <label className="block body-xs  font-medium text-gray-700">Status</label>
                <p className="heading-lg text-gray-900 font-medium mt-1">
              ...
              <div>
                <label className="block body-xs  font-medium text-gray-700">Slave ID</label>
                <p className="heading-lg text-gray-900 font-medium mt-1">{selectedMeter.slaveId}</p>
              </div>
              <div>
                <label className="block body-xs  font-medium text-gray-700">Last Seen</label>
                <p className="heading-lg text-gray-900 font-medium mt-1 flex items-center">
                  <Clock className="w-4 h-4 mr-1 text-gray-500" />
                  {formatDate(selectedMeter.lastSeen)}
                </p>
              </div>
              <div>
                <label className="block body-xs  font-medium text-gray-700">Assignment Status</label>
                <p className="heading-lg text-gray-900 font-medium mt-1">
              ...
              {selectedMeter.isAssigned && (
                <>
                  <div>
                    <label className="block body-xs  font-medium text-gray-700">Assigned User</label>
                    <p className="heading-lg text-gray-900 font-medium mt-1">{selectedMeter.assignedUserName}</p>
                  </div>
                  <div>
                    <label className="block body-xs  font-medium text-gray-700">Assignment Date</label>
                    <p className="heading-lg text-gray-900 font-medium mt-1 flex items-center">
                      <Clock className="w-4 h-4 mr-1 text-gray-500" />
              ...
              <div className="md:col-span-2">
                <label className="block body-xs  font-medium text-gray-700">Created At</label>
                <p className="heading-lg text-gray-900 font-medium mt-1 flex items-center">
                  <Clock className="w-4 h-4 mr-1 text-gray-500" />
