    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-blue-100/30 backdrop-blur-sm px-2">
      <div className="bg-white/90 backdrop-blur-lg rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="p-4 sm:p-6">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-lg sm:heading-xl   font-bold text-gray-900">Edit User</h2>
            <button
              onClick={() => setEditingUserId(null)}
              className="text-gray-400 hover:text-gray-500"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              ...
              <input
                ...
                className={`w-full p-2 border ${editUserErrors.name ? 'border-red-500' : 'border-gray-300'} rounded-md body-sm  `}
              />
              {editUserErrors.name && (
                <p className="mt-1 body-xs  text-red-500">{editUserErrors.name}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2 border ${editUserErrors.email ? 'border-red-500' : 'border-gray-300'} rounded-md body-sm  `}
              />
              {editUserErrors.email && (
                <p className="mt-1 body-xs  text-red-500">{editUserErrors.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full p-2 border ${editUserErrors.phone ? 'border-red-500' : 'border-gray-300'} rounded-md body-sm  `}
                placeholder="10 digits only"
              />
              {editUserErrors.phone && (
                <p className="mt-1 body-xs  text-red-500">{editUserErrors.phone}</p>
              )}
            </div>
            ...
            {editUserData.role === "user" && (
              <div>
                ...
                <input
                  ...
                  className={`w-full p-2 border ${editUserErrors.adminId ? 'border-red-500' : 'border-gray-300'} rounded-md body-sm  `}
                  disabled={!!currentAdmin?.adminId || !!currentAdmin?._id}
                />
                {editUserErrors.adminId && (
                  <p className="mt-1 body-xs  text-red-500">{editUserErrors.adminId}</p>
                )}
              </div>
            )}
            ...
            {(editUserData.role === "user" || editUserData.role === "admin") && (
              <div>
                ...
                <input
                  ...
                  className={`w-full p-2 border ${editUserErrors.superAdminId ? 'border-red-500' : 'border-gray-300'} rounded-md body-sm  `}
                  disabled={!!currentAdmin?.superAdminId || !!currentAdmin?._id}
                />
                {editUserErrors.superAdminId && (
                  <p className="mt-1 body-xs  text-red-500">{editUserErrors.superAdminId}</p>
                )}
              </div>
            )}
          </div>
