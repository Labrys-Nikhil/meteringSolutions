  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="grid grid-cols-2 gap-6 mt-6">
        ...
        <div>
          <h3 className="text-gray-600 body-sm  ">Current Balance</h3>
        ...
        <div className="p-4 bg-gray-100 rounded-lg">
          <h3 className="text-gray-600 body-sm  ">Last Deduction</h3>
          <p className="text-2xl font-bold text-red-500">$ {lastDeduction}</p>
          <p className="text-gray-500 body-xs ">{deductionDate}</p>
        </div>
      </div>
