    ...
    return (
        <div className="max-w-5xl mx-auto p-8 bg-[#ffffff] shadow-2xl border border-[#e5e7eb] print-page">
                ...
                <div className="flex justify-between items-start">
                    <div className="flex-1">
                        <div className="flex items-center mb-4">
                            ...
                            <div>
                                ...
                                <p className="body-sm   text-[#4b5563] font-medium">Electric Utility Services</p>
                            </div>
                        </div>
                        <div className="text-xm text-[#374151] leading-relaxed">
                            <p className="font-semibold body-sm   mb-1">{invoiceData.utilityCompany.address}</p>
                            ...
                            <p className="body-xs  text-[#6b7280]">{invoiceData.utilityCompany.license}</p>
                        </div>
                    </div>
                    <div className="text-right">
                        <div className="bg-[#ecfeff] flex flex-col justify-start items-center p-4 rounded-lg border border-[#67e8f9]">
                            ...
                            <div className="body-sm   text-[#374151] space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                    ...
                    <div className="bg-[#f9fafb] p-4 rounded-lg border border-[#e5e7eb]">
                        <div className="space-y-1 body-xs ">
                            <div className="font-bold text-[#1f2937] body-sm  ">{invoiceData.customerInfo.name}</div>
                ...
                <div className="bg-[#ffffff] border border-[#d1d5db] rounded-lg overflow-hidden">
                    <table className="w-full">
                        <thead className="bg-[#0e7490] text-[#ffffff]">
                            <tr>
                                <th className="px-6 py-4 text-left body-sm   font-bold">Meter Information</th>
                                <th className="px-6 py-4 text-right body-sm   font-bold">Previous Reading</th>
                                <th className="px-6 py-4 text-right body-sm   font-bold">Current Reading</th>
                                <th className="px-6 py-4 text-right body-sm   font-bold">Usage (kWh)</th>
                            </tr>
                        </thead>
                                ...
                                <tr key={index} className="hover:bg-[#f9fafb]">
                                    <td className="p-4">
                                        <div className="body-sm  ">
                                            ...
                                            <div className="text-[#6b7280] body-xs ">Location: {reading.meterLocation}</div>
                                        </div>
                                    </td>
                ...
                <div className="bg-[#ffffff] border border-[#d1d5db] rounded-lg overflow-hidden">
                    <table className="w-full">
                        <thead className="bg-[#f3f4f6]">
                            <tr>
                                <th className="px-6 py-3 text-left body-sm   font-bold text-[#374151]">Description</th>
                                <th className="px-6 py-3 text-right body-sm   font-bold text-[#374151]">Usage (kWh)</th>
                                <th className="px-6 py-3 text-right body-sm   font-bold text-[#374151]">Rate per kWh</th>
                                <th className="px-6 py-3 text-right body-sm   font-bold text-[#374151]">Amount</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-[#e5e7eb]">
                            <tr>
                                <td className="px-6 py-3 body-sm   text-[#1f2937]">Electricity Consumption</td>
                                <td className="px-6 py-3 text-right body-sm   text-[#1f2937]">{invoiceData.meterReadings[0].usage.toLocaleString()}</td>
                                <td className="px-6 py-3 text-right body-sm   text-[#1f2937]">{formatCurrency(invoiceData.tariff.rate)}</td>
                                <td className="px-6 py-3 text-right body-sm   font-semibold text-[#1f2937]">{formatCurrency(multiply(invoiceData.tariff.rate,invoiceData.meterReadings[0].usage))}</td>
                            </tr>
                            <tr className="bg-[#ecfeff]">
                                <td className="px-6 py-3 body-sm   font-bold text-[#0e7490]">Total Energy Charges</td>
                                <td className="px-6 py-3 text-right body-sm   font-bold text-[#0e7490]">{invoiceData.meterReadings[0].usage.toLocaleString()} kWh</td>
                                <td className="px-6 py-3"></td>
                                <td className="px-6 py-3 text-right body-sm   font-bold text-[#0e7490]">{formatCurrency(multiply(invoiceData.tariff.rate,invoiceData.meterReadings[0].usage))}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                    ...
                    <div className="bg-[#fffbeb] border border-[#fde68a] p-6 rounded-lg">
                        <div className="body-sm   text-[#374151] space-y-2">
                            ...
                            <p className="body-xs  text-[#4b5563] mt-3">
            ...
            <div className="bg-[#f9fafb] border border-[#e5e7eb] p-6 rounded-lg mb-6">
                <h3 className="body-sm   font-bold text-[#1f2937] mb-3">TERMS & CONDITIONS</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 body-xs  text-[#4b5563]">
                    <div>
