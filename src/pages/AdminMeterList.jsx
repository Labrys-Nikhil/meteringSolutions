...
//         const baseClasses = "inline-flex items-center px-2.5 py-0.5 rounded-full body-xs  font-medium";
//         if (status === 'online') {
...
//                                     className="w-full sm:w-72 border border-gray-300 rounded-md px-3 py-2 body-sm   text-gray-700"
//                                 />
//                             </div>
//                         </div>
...
//                                     <tr>
//                                         <th className="px-6 py-3 text-left body-xs  font-medium text-gray-500 uppercase tracking-wider">Meter Name</th>
//                                         <th className="px-6 py-3 text-left body-xs  font-medium text-gray-500 uppercase tracking-wider">Meter ID</th>
//                                         <th className="px-6 py-3 text-left body-xs  font-medium text-gray-500 uppercase tracking-wider">Type</th>
//                                         <th className="px-6 py-3 text-left body-xs  font-medium text-gray-500 uppercase tracking-wider">Status</th>
//                                         <th className="px-6 py-3 text-left body-xs  font-medium text-gray-500 uppercase tracking-wider">Assignment</th>
//                                         <th className="px-6 py-3 text-right body-xs  font-medium text-gray-500 uppercase tracking-wider">Assign Date</th>
//                                     </tr>
//                                 </thead>
//                                 {/* <tbody className="bg-white divide-y divide-gray-200">
//                                     {filteredMeters.map((meter) => (
//                                         <tr key={meter._id} className="hover:bg-gray-50">
//                                             <td className="px-6 py-4 body-sm   font-medium text-gray-750">{meter.name}</td>
//                                             <td className="px-6 py-4 body-sm   text-gray-500">{meter.meterId}</td>
//                                             <td className="px-6 py-4 body-sm   text-gray-500">{meter.type}</td>
...
//                                             <td className="px-6 py-4 body-sm   text-gray-700 text-right">
...
//             <h2 className="heading-xl   font-semibold text-gray-800 mb-4">Meter Information</h2>
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700">Meter Name</label>
//                 <p className="text-lg text-gray-900 font-medium mt-1">{selectedMeter.name}</p>
//               </div>
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700">Meter ID</label>
//                 <p className="text-lg text-gray-900 font-medium mt-1">{selectedMeter.meterId}</p>
//               </div>
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700">Meter Type</label>
//                 <p className="text-lg text-gray-900 font-medium mt-1">{selectedMeter.type}</p>
//               </div>
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700">Serial Number</label>
//                 <p className="text-lg text-gray-900 font-medium mt-1">{selectedMeter.meterSerialNumber}</p>
//               </div>
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700">Status</label>
...
//               </div>
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700">Slave ID</label>
//                 <p className="text-lg text-gray-900 font-medium mt-1">{selectedMeter.slaveId}</p>
//               </div>
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700">Last Seen</label>
...
//               </div>
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700">Assignment Status</label>
//                 <p className="text-lg text-gray-900 font-medium mt-1">
...
//                 <>
//                   <div>
//                     <label className="block body-sm   font-medium text-gray-700">Assigned User</label>
//                     <p className="text-lg text-gray-900 font-medium mt-1">{selectedMeter.assignedUserName}</p>
//                   </div>
//                   <div>
//                     <label className="block body-sm   font-medium text-gray-700">Assignment Date</label>
//                     <p className="text-lg text-gray-900 font-medium mt-1 flex items-center">
//                       <Clock className="w-4 h-4 mr-1 text-gray-500" />
...
//                 <label className="block body-sm   font-medium text-gray-700">Created At</label>
//                 <p className="text-lg text-gray-900 font-medium mt-1 flex items-center">
//                   <Clock className="w-4 h-4 mr-1 text-gray-500" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-500">
            Manage meters and their assignments
          </p>
        </div>
