...
//                     <p className="body-sm   text-blue-700">{selectedUser.email}</p>
//                     <p className="body-sm   text-blue-600">{selectedUser.department}</p>
//                   </div>
//                 </div>
...
//                 <div>
//                   <div className="body-xs  text-blue-600 uppercase tracking-wide">Status</div>
//                   <div className={`body-sm   font-medium ${getStatusColor(selectedUser.status)}`}>
//                     {selectedUser.status}
//                   </div>
//                 </div>
//                 <div>
//                   <div className="body-xs  text-blue-600 uppercase tracking-wide">Role</div>
//                   <div className="body-sm   font-medium text-blue-900">
//                     {roleTemplates[selectedUser.role]?.name || selectedUser.role}
//                   </div>
//                 </div>
//                 <div>
//                   <div className="body-xs  text-blue-600 uppercase tracking-wide">Last Login</div>
//                   <div className="body-sm   font-medium text-blue-900">
//                     {selectedUser.lastLogin ? formatDate(selectedUser.lastLogin) : 'Never'}
//                   </div>
//                 </div>
//                 <div>
//                   <div className="body-xs  text-blue-600 uppercase tracking-wide">Member Since</div>
//                   <div className="body-sm   font-medium text-blue-900">
...
//             <div>
//               <label className="block body-sm   font-medium text-gray-700 mb-2">Action Type</label>
//               <select
//                 value={actionType}
//                 onChange={(e) => {
...
//               </select>
//               {actionType && (
//                 <p className="mt-2 body-sm   text-gray-600">{actionTemplates[actionType].description}</p>
//               )}
//             </div>
...
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700 mb-2">New Role</label>
//                 <select
...
//                     <div className="body-sm   font-medium text-gray-700 mb-2">Permissions for this role:</div>
//                     <div className="space-y-1">
//                       {roleTemplates[formData.newRole].permissions.map((permission) => (
//                         <div key={permission} className="flex items-center body-sm   text-gray-600">
...
//               <div>
//                 <label className="block body-sm   font-medium text-gray-700 mb-2">New Status</label>
//                 <select
...
//                 <div>
//                   <label className="block body-sm   font-medium text-gray-700 mb-2">Subject</label>
//                   <input
//                     type="text"
...
//                 </div>
//                 <div>
//                   <label className="block body-sm   font-medium text-gray-700 mb-2">Message</label>
//                   <textarea
            ...
            <div className="mt-4">
              ...
              <div className="flex justify-between items-center mt-1">
                ...
                {formData.statusReason?.length > 500 && (
                  <span className="body-xs  text-red-500">
              ...
              <div className="mt-2">
                <p className="body-xs  text-gray-500 mb-1">Common reasons:</p>
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <button
                      ...
                      className="body-xs  px-2 py-1 bg-gray-100 hover:bg-gray-200 rounded"
                    >
                      {reason}
                    </button>
                  ))}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`px-3 py-1 rounded-full body-xs  font-medium ${getStatusColor(
                    selectedUser.status
                  )}`}
                >
                  {selectedUser.status}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4 pt-4 border-t border-blue-200">
                <div>
                  <div className="body-xs  text-blue-600 uppercase tracking-wide">
                    Last Login
                  </div>
                  <div className="body-sm   font-medium text-blue-900">
