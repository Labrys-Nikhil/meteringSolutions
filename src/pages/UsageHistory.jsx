...
//               <h2 className="heading-xl font-semibold text-slate-800">Date Selection</h2>
//             </div>

//             {/* View Mode Toggle */}
//             <div className="flex items-center gap-4">
//               <div className="flex items-center gap-2">
//                 <span className={`body-xs  ${viewMode === 'single' ? 'font-semibold text-blue-600' : 'text-slate-600'}`}>
//                   Single Day
//                 </span>
//                 <button
...
//                   }
//                 </button>
//                 <span className={`body-xs  ${viewMode === '30day' ? 'font-semibold text-blue-600' : 'text-slate-600'}`}>
//                   30 Day History
//                 </span>
//               </div>
...
//                 <h2 className="heading-xl font-semibold text-slate-800">
...
//                 </select>
//                 <p className="body-xs  text-slate-600">
...
//                     <tr>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Date</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Total Records</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Avg Voltage</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Max EB kWh</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Max DG kWh</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Avg PF</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Avg Balance</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Relay ON %</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">EB Active %</th>
//                       <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Unique Meters</th>
//                     </tr>
//                   </thead>
//                   <tbody className="bg-white divide-y divide-slate-200">
//                     {paginatedData.map((item) => (
//                       <tr key={item._id} className="hover:bg-slate-50 transition-colors">
//                         <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-900">
//                           {item.date.toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
//                         </td>
//                         <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-900 font-semibold">
//                           {item.totalRecords}
//                         </td>
//                         <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-900">
...
//                         </td>
//                         <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-900">
//                           <span className="inline-flex px-2 py-1 body-xsfont-semibold rounded-full bg-green-100 text-green-800">
//                             {item.relayOnPercentage}%
//                           </span>
//                         </td>
//                         <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-900">
//                           <span className="inline-flex px-2 py-1 body-xsfont-semibold rounded-full bg-blue-100 text-blue-800">
//                             {item.ebActivePercentage}%
//                           </span>
//                         </td>
//                         <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-900 font-semibold">
...
//             <div className="body-xs  text-slate-600">
...
//                 className="px-3 py-1 border border-slate-300 rounded-md body-xs  text-slate-600 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
//               >
//                 Previous
//               </button>
//               <span className="px-3 py-1 body-xs  text-slate-600">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-slate-50">
                <tr>
                  <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Date</th>
                  <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Meter ID</th>
                  <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Total kWh</th>
                  <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Total Deduction</th>
                  <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Total EG</th>
                  <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Total DG</th>
                  <th className="px-6 py-3 text-left body-xsfont-medium text-slate-500 uppercase tracking-wider">Created At</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-slate-200">
                {paginatedData.map((item, index) => (
                  <tr key={item._id || index} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-900 font-mono">
                      {item.meterId}
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-900">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap body-xs  text-slate-500">
