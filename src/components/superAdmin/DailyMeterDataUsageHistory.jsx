      ...
      <div className="p-4 max-w-7xl mx-auto">
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-3 min-h-[400px]">
          <div className="sm:w-1/4 mb-3">
            <p className="body-md   font-semibold text-blue-600">
              Meter ID: {meterId}
            </p>
          </div>
            ...
            <>
              {paginatedData.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="body-sm   text-gray-700 font-medium sm:w-1/4 w-full mb-2 sm:mb-0">
                      {usageDate}
                    </div>

                    <div className="body-sm   w-full sm:w-3/4 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
              ...
              <div className="flex justify-center mt-6 gap-4 items-center">
                <button
                  ...
                  disabled={page <= 1}
                  className="px-4 py-2 bg-gray-200 cursor-pointer body-sm   rounded-md disabled:opacity-50"
                >
                  Prev
                </button>
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gray-200 body-sm   cursor-pointer rounded-md disabled:opacity-50"
                >
                  Next
                </button>
              </div>
